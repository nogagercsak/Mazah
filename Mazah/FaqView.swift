...
struct FAQView: View {
    ...
    let faqs = [
        ...
        FAQ(question: "How long can I store meat and seafood?", answer: """
                    ...
                    - Source: USDA
                    """),
        FAQ(question: "How can I extend the shelf life of meat and seafood?", answer: """
        ...
        FAQ(question: "How long can I store leftovers in the fridge?", answer: """
                    ...
                    - Source: USDA
                    """),
        FAQ(question: "This food does not smell or look bad even though its expiration date has expired. Is it still safe to consume?", answer: """
                    ...
                    """),
        FAQ(question: "Can I eat a product after the 'best before' or expiration date?", answer: """
                    ...
                    - Source: International Dairy Foundation
                    """),
        FAQ(question: "Why should I care about food storage and preparation?", answer: """
                    ...
                    """),
        FAQ(question: "How can I tell if food has gone bad?", answer: """
                    - Look for changes in color, texture, or smell.
                    - Check for mold or unusual spots.
                    - Throw away moldy food!
                    """),
        FAQ(question: "What temperature should I keep my fridge at?", answer: """
