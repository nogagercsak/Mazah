...
const styles = StyleSheet.create({
  ...
  mealDots: { flexDirection: 'row', marginTop: 8, gap: 4 },
  mealDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: proto.textSecondary, opacity: 0.5 },
  mealDotSelected: { backgroundColor: proto.buttonText, opacity: 0.9, transform: [{ scale: 1.1 }] },
